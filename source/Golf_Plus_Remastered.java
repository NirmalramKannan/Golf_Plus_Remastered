...
public class Golf_Plus_Remastered extends PApplet {
...
//---------------------------------------------------------------------------- Ball Physics
  if (motion == true){
    ...
    if(incrx >= -0.2f && incrx <= 0.2f){
      incrx = 0;
    }
    if(incry >= -0.2f && incry <= 0.2f){
      incry = 0;
    }
...
//----------------------------------------------------------------------------
 public void mouseClicked(){
  if (motion == false && game == true){
    incrx = ((ballx+(ballx-mouseX)) - ballx)*0.1f;
    incry = ((bally+(bally-mouseY)) - bally)*0.1f;
    ax = abs(incrx/300);
    ay = abs(incry/300);
    motion = true;
  }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Golf_Plus_Remastered" };
    if (passedArgs != null) {
